...
hi LineNr ctermfg=102 ctermbg=59 cterm=NONE guifg=#3d4751 guibg=dark gui=NONE
hi VertSplit ctermfg=234 ctermbg=234 cterm=NONE guifg=NONE guibg=NONE gui=NONE
...
hi Boolean ctermfg=88 ctermbg=NONE cterm=NONE guifg=#70495d guibg=NONE gui=bold
...
hi Function ctermfg=74 ctermbg=NONE cterm=bold guifg=#72aaca guibg=NONE gui=bold
...
hi String ctermfg=2 ctermbg=NONE cterm=NONE guifg=#00b20c guibg=NONE gui=NONE
...
" custom:
hi pythonMagic    guibg=NONE guifg=#72aaca gui=NONE
